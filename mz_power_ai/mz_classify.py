...
import pandas as pd
chatbot_data = pd.read_excel('/workspace/KhuthonServer1/result2.xlsx')

chatbot_data = chatbot_data.dropna()
chatbot_data['label']=chatbot_data['label'].astype(int)
chatbot_data.loc[(chatbot_data['text'] == "!MZ"), 'MZ_Power'] = 0  #부정 => 0
chatbot_data.loc[(chatbot_data['text'] == "MZ"), 'MZ_Power'] = 1  #긍정 => 1
...
warmup_ratio = 0.1
num_epochs = 2        # default 5
max_grad_norm = 1
log_interval = 200
learning_rate =  5e-5 # default 5e-5
max_len = 64          # default 64
# ★
